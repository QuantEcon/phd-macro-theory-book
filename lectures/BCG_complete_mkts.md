...
A Big K, little k analysis also played roles in [this](https://python-advanced.quantecon.org/cass_koopmans_2.html) quantecon lecture as well  as [here](https://python-advanced.quantecon.org/rational_expectations.html) and {doc}`here <dyn_stack>`.
